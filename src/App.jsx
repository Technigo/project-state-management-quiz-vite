...
const App = () => {
  ...
  return (
    <>
      ...
      <header><h1 className="text-3xl md:text-5xl top-0 font-mono m-10 font-bold text-center bg-gradient-to-r from-pink-400 via-sky-400 to-emerald-400 text-transparent bg-clip-text">Can You Make It As A Frontend Developer?</h1></header>
