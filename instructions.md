...
- We've initialized a context for the quiz in the `./src/context/QuizContext.jsx` file. This context will manage the state of your quiz and provide functions to interact with it.
